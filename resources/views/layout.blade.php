          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Machiato</a></li>
                <li><a href="#" class="py-2 d-block">Cà phê truyền thống</a></li>
                <li><a href="#" class="py-2 d-block">Gói cà phê</a></li>
                <li><a href="#" class="py-2 d-block">Cà phê hiện đại</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
