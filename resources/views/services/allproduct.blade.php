    	...
    	<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 heading-section text-center ftco-animate">
					<span class="subheading" style="margin-bottom: 15px">Burn Coffee</span>
	    		...
	    		<div class="col-lg-12 ftco-animate ">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
					...
					@foreach($loaisp as $loai)
						@if ($loop->first)
							<a style="margin-right: 5px" class="nav-link active"  id="v-pills-<?= $loai->Id_LoaiSP ?>-tab" data-toggle="pill" href="#v-pills-<?= $loai->Id_LoaiSP ?>" role="tab" aria-controls="v-pills-<?= $loai->Id_LoaiSP ?>" aria-selected="true"><?= $loai->Ten_LoaiSP ?></a>
						@else
							<a style="margin-right: 5px" class="nav-link" id="v-pills-<?= $loai->Id_LoaiSP ?>-tab" data-toggle="pill" href="#v-pills-<?= $loai->Id_LoaiSP ?>" role="tab" aria-controls="v-pills-<?= $loai->Id_LoaiSP ?>" aria-selected="false"><?= $loai->Ten_LoaiSP ?></a>
						@endif
					@endforeach
		            </div>
