...
<div class="col-lg-12 col-md-12">
    <div class="chua">
        ...
        <a href="{{ route('danhmuc.create')}}" style="color: white;"><i class="zmdi zmdi-plus"></i>Thêm Danh Mục</a></button>
    </div>      
                    ...
                    <tr>
                        ...
                        <td class="td-actions">
                            <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                <a href="{{route('danhmuc.edit',$row->Id_DM)}}"><i class="material-icons">Edit</i></a>
                            </button>
                            
                            <form action="{{route('danhmuc.destroy',$row->Id_DM)}}" method="post" class="btn btn-link btn-sm">
                                {{  csrf_field() }}
                                {!! method_field('delete') !!}
